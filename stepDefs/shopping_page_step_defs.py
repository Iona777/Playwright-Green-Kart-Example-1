...
from conftest import shopping_login_page, sharedData
...
def takeNoteOfSumOfProducts(shopping_dashboard_page:ShoppingDashboardPage,sharedData):
...
def checkNewSum(shopping_dashboard_page:ShoppingDashboardPage, newSum, sharedData):
